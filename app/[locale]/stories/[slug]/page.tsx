        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              >
                <ArrowLeft className="mr-2 h-4 w-4" /> {t('stories.backToStories')}
              </Link>
            </motion.div>
            ...
            >
              <Button asChild variant="outline" className="rounded-none">
                <Link href="/stories">
                  <ArrowLeft className="mr-2 h-4 w-4" /> {t('stories.previousStory')}
                </Link>
              </Button>
              <Button asChild className="rounded-none">
                <Link href="/stories">
                  {t('stories.nextStory')} <ArrowRight className="ml-2 h-4 w-4" />
                </Link>
              </Button>
            </motion.div>
          </div>
