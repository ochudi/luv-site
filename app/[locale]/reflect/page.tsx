...
const cards = [
  { titleKey: "lettingGo", slug: "letting-go" },
  { titleKey: "beautyInUncertainty", slug: "beauty-uncertainty" },
  { titleKey: "learningFromStillness", slug: "learning-stillness" },
];
        ...
        <div className="editorial-container">
          ...
          >
            <div className="md:col-span-3">
              ...
              <p className="eyebrow mt-1">Insight</p>
            </div>
