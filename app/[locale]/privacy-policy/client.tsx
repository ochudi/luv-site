        ...
        <div className="editorial-container">
          ...
          >
            <div className="md:col-span-3">
              ...
              <p className="eyebrow mt-1">Privacy</p>
            </div>
              ...
              {sections.map((s, i) => (
                ...
                >
                  ...
                  <p className="text-[16px] md:text-[17px] text-foreground/80 leading-[1.75]">
                    {s.key === "accessToInfo" ? (
                      <>
                        {p("accessToInfoText").split("dataprotection@lifeupsideview.org")[0]}
                        <a
                        ...
                        {p("accessToInfoText").split("dataprotection@lifeupsideview.org")[1] || ""}
                      </>
                    ) : (
                      p(`${s.key}Text`)
                    )}
