...
export default function CookiePolicyPage() {
  ...
  const p = useTranslations('policies.cookiePolicy');
  return (
    <motion.section
    ...
    >
      <div className="w-full max-w-2xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
        ...
        <div className="space-y-6 text-gray-700 text-base leading-relaxed">
          <section>
            <h2 className="text-xl font-semibold mb-2">{p('whatAreCookies')}</h2>
            <p>{p('whatAreCookiesText')}</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold mb-2">{p('howWeUse')}</h2>
            <p>{p('howWeUseText')}</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold mb-2">{p('managing')}</h2>
            <p>{p('managingText')}</p>
          </section>
          <section>
            <h2 className="text-xl font-semibold mb-2">{p('thirdParty')}</h2>
            <p>{p('thirdPartyText')}</p>
          </section>
          <section>
