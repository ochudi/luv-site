      ...
      <div className="w-full max-w-2xl mx-auto bg-white rounded-2xl shadow-lg p-8 md:p-12">
        ...
        <div className="space-y-6 text-gray-700 text-base leading-relaxed">
          ...
          <section>
            ...
            <p>If you have any questions about our Cookie Policy, please contact us at <a href="mailto:revenserom@gmail.com" className="text-yellow-600 underline">revenserom@gmail.com</a>.</p>
          </section>
        </div>
      </div>
    </motion.section>
