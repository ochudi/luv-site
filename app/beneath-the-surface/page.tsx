        ...
        <div className="container mx-auto px-4">
          ...
          >
            <motion.div variants={item} className="group">
              <Link
                href="/beneath-the-surface/yacht-charter/subsea-thrills-submarine-treasure-hunt-legend"
                className="block"
              >
            ...
            <motion.div variants={item} className="group">
              <Link href="/beneath-the-surface/yco-news/team-talk-holly-bottau-interview" className="block">
                <div className="relative h-[400px] mb-6 overflow-hidden">
                  <Image
                    src="/placeholder.svg?height=800&width=1200"
                    alt="Team interview"
